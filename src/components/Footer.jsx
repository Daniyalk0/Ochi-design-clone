...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 flex gap-5 font-custom" >
      <div className="w-1/2 p-16 h-full flex flex-col justify-between">
        <div className="heading ">
          <h1 className="text-[9vw] font-bold -mb-[1vw] leading-none">EYE-</h1>
          <h1 className="text-[9vw] font-bold -mb-[1vw] leading-none">
            OPENING
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[9vw] font-bold pt-20  leading-none">
          PRESENTATIONS
        </h1>
        <div className="dets font-new mt-20">
          {[
            `Instagram
Behance`,
            `Facebook`,
...
Linkedin`,
            ...
            <a href="#" className=" block  text-sm" key={index}>
              {chacha}
            </a>
          ))}
        </div>
